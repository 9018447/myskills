...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.core.functions

# Source code for scm.plams.core.functions
[code]
    import os
    import re
    import shutil
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.init)def init(path=None, folder=None, config_settings:Dict=None, quiet=False, use_existing_folder=False):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.finish)def finish(otherJM=None):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.load)def load(filename):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.load_all)def load_all(path, jobmanager=None):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.read_molecules)def read_molecules(folder, formats=None):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.read_all_molecules_in_xyz_file)def read_all_molecules_in_xyz_file(filename):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.log)def log(message, level=0):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.add_to_class)def add_to_class(classname):
    ...
    [[docs]](../../../../components/functions.html#scm.plams.core.functions.add_to_instance)def add_to_instance(instance):
