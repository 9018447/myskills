...
__[PLAMS](../../../../../index.html)
  ...
  * scm.plams.interfaces.adfsuite.densf
...
[code]
    ...
    [[docs]](../../../../../interfaces/postadf.html#scm.plams.interfaces.adfsuite.densf.DensfJob)class DensfJob(SCMJob):
    ...
    [[docs]](../../../../../interfaces/postadf.html#scm.plams.interfaces.adfsuite.densf.DensfJob.__init__)    def __init__(self, inputjob=None, **kwargs):
            SCMJob.__init__(self, **kwargs)
            self.inputjob = inputjob
    
    [[docs]](../../../../../interfaces/postadf.html#scm.plams.interfaces.adfsuite.densf.DensfJob._serialize_mol)    def _serialize_mol(self):
            self.settings.input.inputfile = self.inputjob
    
    [[docs]](../../../../../interfaces/postadf.html#scm.plams.interfaces.adfsuite.densf.DensfJob._remove_mol)    def _remove_mol(self):
            if 'inputfile' in self.settings.input:
                del self.settings.input.inputfile
    
    [[docs]](../../../../../interfaces/postadf.html#scm.plams.interfaces.adfsuite.densf.DensfJob.check)    def check(self):
            try:
