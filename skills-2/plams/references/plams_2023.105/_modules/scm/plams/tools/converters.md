...
# Source code for scm.plams.tools.converters
[code]
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.traj_to_rkf)def traj_to_rkf(trajfile,  rkftrajectoryfile, task=None, timestep:float=0.25):
        """
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.file_to_traj)def file_to_traj(outfile, trajfile):
        """
        outfile : str
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.vasp_output_to_ams)def vasp_output_to_ams(vasp_folder, wdir=None, overwrite=False, write_engine_rkf=True, task:str=None, timestep:float=0.25):
        """ 
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.qe_output_to_ams)def qe_output_to_ams(qe_outfile, wdir=None, overwrite=False, write_engine_rkf=True):
        """
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.gaussian_output_to_ams)def gaussian_output_to_ams(outfile, wdir=None, overwrite=False, write_engine_rkf=True):
        """
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.rkf_to_ase_atoms)def rkf_to_ase_atoms(rkf_file, get_results=True):
        """
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.converters.rkf_to_ase_traj)def rkf_to_ase_traj(rkf_file, out_file, get_results=True):
        """
