...
This example illustrates how set up an AMS calculation using the [M3GNet 2022 Universal Potential from the MLPotential Engine](../../MLPotential/general.html).

**Example usage:** ([`Download M3GNet.py`](../_downloads/06dd7af99a70f3f9324744ebbb865977/M3GNet.py))
[code] 
...
[Next ](XRD/XRD.html "X-Ray Diffraction \(XRD\)") [ Previous](UseLowestEnergy.html "Hybrid engine: Use lowest energy")
