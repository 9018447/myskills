...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.trajectories.rkffile

# Source code for scm.plams.trajectories.rkffile
[code]
    #!/usr/bin/env python
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile)class RKFTrajectoryFile (TrajectoryFile) :
            """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.__init__)        def __init__ (self, filename, mode='rb', fileobject=None, ntap=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.store_mddata)        def store_mddata (self, rkf=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.store_historydata)        def store_historydata (self) :
                    """
                    Read/write non-standard entries in the History section
                    """
                    self.include_historydata = True
    
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.close)        def close (self, override_molecule_section_with_last_frame=True) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile._rewrite_molecule)        def _rewrite_molecule (self) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile._update_celldata)        def _update_celldata (self, cell) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.get_plamsmol)        def get_plamsmol (self) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.read_frame)        def read_frame (self, i, molecule=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile._store_historydata_for_step)        def _store_historydata_for_step (self, istep) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.read_next)        def read_next (self, molecule=None, read=True) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.write_next)        def write_next (self, coords=None, molecule=None, cell=[0.,0.,0.], conect=None, historydata=None, mddata=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile._set_energy)        def _set_energy (self, mddata, historydata) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile._write_dictionary_to_history)        def _write_dictionary_to_history (self, data, section, counter=1) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile._flatten_variable)        def _flatten_variable (self, var) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.rewind)        def rewind (self, nframes=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.get_length)        def get_length (self) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkffile.RKFTrajectoryFile.read_last_frame)        def read_last_frame (self, molecule=None) :
                    """
