...
In this example, the AMS _engine_ is replaced by an ASE calculator.

In the [AMSCalculator: ASE geometry optimizer with AMS forces](AMSCalculator/ASECalculator.html#amscalculatorexample), [i-PI path integral MD with AMS](i-PI-AMS.html#ipiexample), and [Sella transition state search with AMS](SellaTransitionStateSearch.html#sellaexample) examples, the AMS _driver_ is replaced by external codes that use the AMS _engine_ energies and forces.

**Example usage:** ([`Download CustomASECalculator.py`](../_downloads/bd22173cb44c3eb4bb9aff1d4628c315/CustomASECalculator.py))
[code] 
...
[Next ](AMSCalculator/ASECalculator.html "AMSCalculator: ASE geometry optimizer with AMS forces") [ Previous](PackMolExample/PackMolExample.html "Packmol example")
