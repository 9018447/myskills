...
[code]
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.twist)def twist(v1, v2, v3, tolerance=None):
        """
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.bend)def bend(v1, v2, tolerance=None):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.unique_atoms)def unique_atoms(atomlist):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.initialize)def initialize(molecule):
        """Initialize atom labeling algorithm by setting ``IDname`` and ``IDdone`` attributes for all atoms in *molecule*."""
        for at in molecule:
            at.IDname = at.symbol
            at.IDdone = False
    
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.clear)def clear(molecule):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.iterate)def iterate(molecule, flags):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.new_name)def new_name(atom, flags):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.knock)def knock(A, bond, flags):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.label_atoms)def label_atoms(molecule, **kwargs):
    ...
    [[docs]](../../../../components/mol_api.html#scm.plams.mol.molecule.molecule_name)def molecule_name(molecule):
