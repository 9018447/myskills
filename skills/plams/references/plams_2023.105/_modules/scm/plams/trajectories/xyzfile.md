...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.trajectories.xyzfile
...
[code]
    ...
    [[docs]](../../../../components/xyz.html#scm.plams.trajectories.xyzfile.XYZTrajectoryFile)class XYZTrajectoryFile (TrajectoryFile) :
            """
    ...
    [[docs]](../../../../components/xyz.html#scm.plams.trajectories.xyzfile.XYZTrajectoryFile.__init__)        def __init__ (self, filename, mode='r', fileobject=None, ntap=None) :
                    """
    ...
    [[docs]](../../../../components/xyz.html#scm.plams.trajectories.xyzfile.XYZTrajectoryFile.store_historydata)        def store_historydata (self) :
                    """
                    Additional data should be read from/written to file
                    """
                    self.include_historydata = True
    
    [[docs]](../../../../components/xyz.html#scm.plams.trajectories.xyzfile.XYZTrajectoryFile.set_name)        def set_name (self, name) :
                    """
    ...
    [[docs]](../../../../components/xyz.html#scm.plams.trajectories.xyzfile.XYZTrajectoryFile.read_next)        def read_next (self, molecule=None, read=True) :
                    """
    ...
    [[docs]](../../../../components/xyz.html#scm.plams.trajectories.xyzfile.XYZTrajectoryFile.write_next)        def write_next (self,coords=None,molecule=None,cell=[0.,0.,0.],conect=None,historydata=None) :
                    """
