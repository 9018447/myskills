...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.core.basejob

# Source code for scm.plams.core.basejob
[code]
    import os
    import stat
    import threading
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job)class Job:
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.__init__)    def __init__(self, name='plamsjob', settings=None, depend=None):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.run)    def run(self, jobrunner=None, jobmanager=None, **kwargs):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.pickle)    def pickle(self, filename=None):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.ok)    def ok(self, strict=True):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.check)    def check(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.hash)    def hash(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.prerun)    def prerun(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.postrun)    def postrun(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job._prepare)    def _prepare(self, jobmanager):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job._get_ready)    def _get_ready(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job._execute)    def _execute(self, jobrunner):
            """Execute the job. Abstract method."""
            raise PlamsError('Trying to run an abstract method Job._execute()')
    
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job._finalize)    def _finalize(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job.__getstate__)    def __getstate__(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.Job._log_status)    def _log_status(self, level):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob)class SingleJob(Job):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.__init__)    def __init__(self, molecule=None, **kwargs):
            Job.__init__(self, **kwargs)
            self.molecule = molecule.copy() if isinstance(molecule, Molecule) else molecule
    
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.get_input)    def get_input(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.get_runscript)    def get_runscript(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.hash_input)    def hash_input(self):
            """Calculate SHA256 hash of the input file."""
            return sha256(self.get_input())
    
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.hash_runscript)    def hash_runscript(self):
            """Calculate SHA256 hash of the runscript."""
            return sha256(self.full_runscript())
    
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.hash)    def hash(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.check)    def check(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.full_runscript)    def full_runscript(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob._get_ready)    def _get_ready(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob._execute)    def _execute(self, jobrunner):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.load)    @classmethod
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.SingleJob.load_external)    @classmethod
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob)class MultiJob(Job):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.__init__)    def __init__(self, children=None, childrunner=None, **kwargs):
            Job.__init__(self, **kwargs)
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.new_children)    def new_children(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.hash)    def hash(self):
            """Hashing for multijobs is disabled by default. Returns ``None``."""
            return None
    
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.check)    def check(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.other_jobs)    def other_jobs(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.remove_child)    def remove_child(self, job):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob._get_ready)    def _get_ready(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob.__iter__)    def __iter__(self):
            """Iterate through ``children``. If it is a dictionary, iterate through its values."""
            if isinstance(self.children, dict):
                return iter(self.children.values())
            return iter(self.children)
    
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob._notify)    def _notify(self):
    ...
    [[docs]](../../../../components/jobs.html#scm.plams.core.basejob.MultiJob._execute)    def _execute(self, jobrunner):
