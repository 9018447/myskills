...
# Source code for scm.plams.tools.periodic_table
[code]
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable)class PeriodicTable:
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.__init__)    def __init__(self):
            raise PTError('Instances of PeriodicTable cannot be created')
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_atomic_number)    @classmethod
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_symbol)    @classmethod
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_mass)    @classmethod
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_radius)    @classmethod
        def get_radius(cls, arg):
            """Convert atomic symbol or atomic number to radius."""
            return cls._get_property(arg, 2)
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_connectors)    @classmethod
        def get_connectors(cls, arg):
            """Convert atomic symbol or atomic number to number of connectors."""
            return cls._get_property(arg, 3)
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_metallic)    @classmethod
        def get_metallic(cls, arg):
            """Convert atomic symbol or atomic number to number of connectors."""
            return cls._get_property(arg, 4)
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.get_electronegative)    @classmethod
        def get_electronegative(cls, arg):
            """Convert atomic symbol or atomic number to number of connectors."""
            return cls._get_property(arg, 5)
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.set_mass)    @classmethod
        def set_mass(cls, element, value):
            """Set the mass of *element* to *value*."""
            cls.data[cls.get_atomic_number(element)][1] = value
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.set_radius)    @classmethod
        def set_radius(cls, element, value):
            """Set the radius of *element* to *value*."""
            cls.data[cls.get_atomic_number(element)][2] = value
    
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable.set_connectors)    @classmethod
    ...
    [[docs]](../../../../components/utils.html#scm.plams.tools.periodic_table.PeriodicTable._get_property)    @classmethod
