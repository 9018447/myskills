...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.trajectories.rkfhistoryfile

# Source code for scm.plams.trajectories.rkfhistoryfile
[code]
    #!/usr/bin/env python
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile)class RKFHistoryFile (RKFTrajectoryFile) :
            """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile.__init__)        def __init__ (self, filename, mode='rb', fileobject=None, ntap=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile.get_plamsmol)        def get_plamsmol (self) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile._rewrite_molecule)        def _rewrite_molecule (self) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile._correct_chemical_system)        def _correct_chemical_system (self, elements, prev_elements, added_atoms, removed_atoms) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile.write_next)        def write_next (self, coords=None, molecule=None, elements=None, cell=[0.,0.,0.], conect=None, historydata=None, mddata=None) :
                    """
    ...
    [[docs]](../../../../components/rkf.html#scm.plams.trajectories.rkfhistoryfile.RKFHistoryFile._set_system_version_elements)        def _set_system_version_elements (self) :
                    """
