...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.core.jobrunner

# Source code for scm.plams.core.jobrunner
[code]
    import os
    import functools
    import threading
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner._in_thread)def _in_thread(func):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner._limit)def _limit(func):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner._MetaRunner)class _MetaRunner(type):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner._MetaRunner.__new__)    def __new__(meta, name, bases, dct):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.JobRunner)class JobRunner(metaclass=_MetaRunner):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.JobRunner.__init__)    def __init__ (self, parallel=False, maxjobs=0, maxthreads=256):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.JobRunner.call)    def call(self, runscript, workdir, out, err, runflags):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.JobRunner._run_job)    @_in_limited_thread
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.GridRunner)class GridRunner(JobRunner):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.GridRunner.__init__)    def __init__(self, grid='auto', sleepstep=5, parallel=True, maxjobs=0):
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.GridRunner.call)    def call(self, runscript, workdir, out, err, runflags):
            """call(runscript, workdir, out, err, runflags)
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.GridRunner._check_queue)    @_in_thread
    ...
    [[docs]](../../../../components/runners.html#scm.plams.core.jobrunner.GridRunner._autodetect)    def _autodetect(self):
