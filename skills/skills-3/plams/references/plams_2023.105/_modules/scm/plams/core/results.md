...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.core.results

# Source code for scm.plams.core.results
[code]
    import copy
    import functools
    import glob
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results._caller_name_and_arg)def _caller_name_and_arg(frame):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results._privileged_access)def _privileged_access():
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results._restrict)def _restrict(func):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results._MetaResults)class _MetaResults(type):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results._MetaResults.__new__)    def __new__(meta, name, bases, dct):
            for attr in dct:
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results)class Results(metaclass=_MetaResults):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.__init__)    def __init__(self, job):
            self.job = job
            self.files = []
            self.finished = threading.Event()
            self.done = threading.Event()
    
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.refresh)    def refresh(self):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.collect)    def collect(self):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.wait)    def wait(self):
            """wait()
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.grep_file)    def grep_file(self, filename, pattern='', options=''):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.grep_output)    def grep_output(self, pattern='', options=''):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.read_file)    def read_file(self, filename:str) -> str:
            """
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.regex_file)    def regex_file(self, filename:str, regex:str) -> List:
            """
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.awk_file)    def awk_file(self, filename, script='', progfile=None, **kwargs):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.awk_output)    def awk_output(self, script='', progfile=None, **kwargs):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.rename)    def rename(self, old, new):
            """rename(old, new)
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.get_file_chunk)    def get_file_chunk(self, filename, begin=None, end=None, match=0, inc_begin=False, inc_end=False, process=None):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.get_output_chunk)    def get_output_chunk(self, begin=None, end=None, match=0, inc_begin=False, inc_end=False, process=None):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.recreate_molecule)    def recreate_molecule(self):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.recreate_settings)    def recreate_settings(self):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results._clean)    def _clean(self, arg):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results._copy_to)    def _copy_to(self, newresults):
            """_copy_to(newresults)
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results._export_attribute)    def _export_attribute(self, attr, other):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results._replace_job_name)    @staticmethod
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.__getitem__)    def __getitem__(self, name):
    ...
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results.__contains__)    def __contains__(self, name):
            """Magic method to enable the Python ``in`` operator notation for checking if a filename with a particular name is present."""
            name = name.replace('$JN', self.job.name)
            return name in self.files
    
    [[docs]](../../../../components/results.html#scm.plams.core.results.Results._process_file)    def _process_file(self, filename, command):
