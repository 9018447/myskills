...
# Source code for scm.plams.mol.atom
[code]
    import math
    import numpy as np
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom)class Atom:
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.__init__)    def __init__(self, atnum=0, symbol=None, coords=None, unit='angstrom', bonds=None, mol=None, **other):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.str)    def str(self, symbol=True, suffix='', suffix_dict={}, unit='angstrom', space=14, decimal=6):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.__str__)    def __str__(self):
            """Return a string representation of this atom. Simplified version of :meth:`str` to work as a magic method."""
            return self.str()
    
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.__iter__)    def __iter__(self):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.translate)    def translate(self, vector, unit='angstrom'):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.move_to)    def move_to(self, point, unit='angstrom'):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.distance_to)    def distance_to(self, point, unit='angstrom', result_unit='angstrom'):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.vector_to)    def vector_to(self, point, unit='angstrom', result_unit='angstrom'):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.angle)    def angle(self, point1, point2, point1unit='angstrom', point2unit='angstrom',result_unit='radian'):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.rotate)    def rotate(self, matrix):
    ...
    [[docs]](../../../../components/atombond.html#scm.plams.mol.atom.Atom.neighbors)    def neighbors(self):
