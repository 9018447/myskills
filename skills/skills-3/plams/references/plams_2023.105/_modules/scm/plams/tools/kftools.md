...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.tools.kftools

# Source code for scm.plams.tools.kftools
[code]
    import numpy
    import os
    import shutil
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader)class KFReader:
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader.__init__)    def __init__(self, path, blocksize=4096, autodetect=True):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader.read)    def read(self, section, variable):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader.variable_type)    def variable_type(self, section, variable):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader.__iter__)    def __iter__(self):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader._autodetect)    def _autodetect(self):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader._read_block)    def _read_block(self, f, pos):
            """Read a single block of binary data from posistion *pos* in file *f*."""
            f.seek((pos-1)*self._blocksize)
            return f.read(self._blocksize)
    
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader._parse)    def _parse(self, block, format):   #format = [(32,'s'),(4,'i'),(2,'d')]
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader._get_data)    def _get_data(self, datablock, vtype):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader._create_index)    def _create_index(self):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFReader._datablocks)    @staticmethod
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile)class KFFile:
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.__init__)    def __init__(self, path, autosave=True):
            self.autosave = autosave
            self.path = os.path.abspath(path)
            self.tmpdata = OrderedDict()
            self.reader = KFReader(self.path) if os.path.isfile(self.path) else None
    
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.read)    def read(self, section, variable, return_as_list=False):
            """Extract and return data for a *variable* located in a *section*.
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.write)    def write(self, section, variable, value, value_type=None):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.save)    def save(self):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.delete_section)    def delete_section(self, section):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.sections)    def sections(self):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.read_section)    def read_section(self, section):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.keys)    def keys(self) -> set:
            """ Returns all sections in the current instance """
            return set([sec for sec,var in self])
    
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.get_skeleton)    def get_skeleton(self):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.__getitem__)    def __getitem__(self, name):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.__setitem__)    def __setitem__(self, name, value):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.__iter__)    def __iter__(self):
            """Iteration yields pairs of section name and variable name."""
            ret = set()
            if self.reader:
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile.__contains__)    def __contains__(self, arg):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile._split)    @staticmethod
        def _split(name):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFFile._str)    @staticmethod
        def _str(val):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFHistory)class KFHistory:
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFHistory.__init__)    def __init__(self, kf, section):
            self.kf = kf
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFHistory.read_all)    def read_all(self, name):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFHistory.iter)    def iter(self, name):
    ...
    [[docs]](../../../../interfaces/kffiles.html#scm.plams.tools.kftools.KFHistory.iter_optional)    def iter_optional(self, name, default=None):
