...
__[PLAMS](../../../../index.html)
  ...
  * scm.plams.trajectories.dcdfile

# Source code for scm.plams.trajectories.dcdfile
[code]
    #!/usr/bin/env python
    ...
    [[docs]](../../../../components/dcd.html#scm.plams.trajectories.dcdfile.DCDTrajectoryFile)class DCDTrajectoryFile (TrajectoryFile) :
            """
    ...
    [[docs]](../../../../components/dcd.html#scm.plams.trajectories.dcdfile.DCDTrajectoryFile.__init__)        def __init__ (self, filename=None, mode='rb', fileobject=None, ntap=None) :
                    """
    ...
    [[docs]](../../../../components/dcd.html#scm.plams.trajectories.dcdfile.DCDTrajectoryFile.set_byteorder)        def set_byteorder (self, byteorder) :
                    """
    ...
    [[docs]](../../../../components/dcd.html#scm.plams.trajectories.dcdfile.DCDTrajectoryFile.read_next)        def read_next (self,molecule=None,read=True) :
                    """
    ...
    [[docs]](../../../../components/dcd.html#scm.plams.trajectories.dcdfile.DCDTrajectoryFile.write_next)        def write_next (self, coords=None, molecule=None, cell=[0.,0.,0.], conect=None) :
                    """
